    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold mb-6 text-white">Class 12 Resources</h2>
      ...
      <div className={`flex-1 p-8 bg-white transition-all duration-300 ${isSidebarOpen ? "blur-sm" : ""}`}>
        ...
        <h1 className="text-4xl font-semibold text-purple-700 mb-6">Class 12th Study Materials</h1>
        <p className="text-lg text-gray-700 mb-6">Welcome to the Class 12 page! Here you'll find all the resources you need to prepare for your exams.</p>
