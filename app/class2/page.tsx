...
const Class11Page: React.FC = () => {
  ...
  const [errorMessage] = useState(() => {
    ...
    const errorMessages = [
      "Oops! No resources found for Class 11.",
      "We're working hard to upload Class 11 files. Stay tuned!",
      "Sorry, the requested files are not available yet.",
      "No files here! Maybe check back later?",
      "Class 11 resources are currently unavailable. Contact the admin for updates.",
      "Hmm, it seems we're missing the files you're looking for.",
      "The cupboard is empty! No Class 11 files available.",
    ];
