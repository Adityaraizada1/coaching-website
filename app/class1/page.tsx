  ...
  return (
    <div className="flex min-h-screen bg-gray-50 justify-center items-center">
      ...
      <div className="flex flex-col items-center justify-center p-8 bg-white rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <h1 className="text-4xl font-semibold text-purple-700 mb-6">Class 10th Resources</h1>
        <p className="text-lg text-gray-700 mb-6 text-center">
          Sorry, there are no files available for Class 10 at the moment. Please contact the owner of the site to request the files.
